        ...
        <div class="card-content">
            <div class="row">
                <div class="form-group col-3">
                    ...
                    {!! Form::select('carriers[]', [], $opportunity->turn_id ?? null, ['class' => 'form-control' . ($errors->first('carriers') ? ' is-invalid' : ''), 'multiple']) !!}
                    @error('carriers')
            ...
            <div class="row">
                <div class="form-group col-12">
                    ...
                    {!! Form::text('title', $opportunity->title ?? null, ['class' => 'form-control' . ($errors->first('title') ? ' is-invalid' : '')]) !!}
                    @error('title')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ ucfirst($message) }}</strong>
                    </span>
