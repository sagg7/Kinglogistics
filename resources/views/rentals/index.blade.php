        ...
        <script defer>
            ...
            (() => {
                ...
                tbAG = new tableAG({
                    ...
                    menu: [
                        {text: 'Create Inspection', route: "/inspection/create", icon: 'feather icon-edit', type: 'dynamic', contdition:'status == "uninspected"'},
                        {text: 'End Rent', route: "/inspection/endInspection", icon: 'feather icon-edit', type: 'dynamic', contdition:'status == "rented"'},
