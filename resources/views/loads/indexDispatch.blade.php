                ...
                let tableProperties = (type) => {
                    ...
                    return {
                        columns: [
                            ...
                            {headerName: '{{session('renames')->customer_reference ?? 'C Reference'}}', field: 'customer_reference', editable: true, valueFormatter: emptyFormatter},
                            {headerName: '{{session('renames')->bol ?? 'BOL'}}', field: 'bol', editable: true, valueFormatter: emptyFormatter},
                            {headerName: '{{session('renames')->tons ?? 'Tons'}}', field: 'tons', editable: true, valueFormatter: emptyFormatter},
                            {headerName: '{{session('renames')->job ?? 'Job'}}', field: 'trip', editable: false, cellRenderer: JobRenderer},
                            {headerName: '{{session('renames')->po ?? 'PO'}}', field: 'customer_po', editable: false, cellRenderer: PoRenderer},
