                ...
                let tableProperties = (type) => {
                    ...
                    return {
                        columns: [
                            ...
                            {headerName: `${session['carrier'] ?? 'Carrier'}`, field: 'driver.carrier', valueFormatter: nameFormatter},
                            {headerName: 'Photos', field: 'load_status', filter: false, cellRenderer: PhotosRenderer},
                            {headerName:  session['control_number'] ?? 'Control #', field: 'control_number', editable: true, valueFormatter: emptyFormatter},
                            {headerName: '{{session('renames') ? session('renames')->customer_reference : 'C Reference'}}', field: 'customer_reference', editable: true, valueFormatter: emptyFormatter},
                            {headerName: '{{session('renames') ? session('renames')->bol : 'BOL'}}', field: 'bol', editable: true, valueFormatter: emptyFormatter},
                            {headerName: '{{session('renames') ? session('renames')->tons : 'Tons'}}', field: 'tons', editable: true, valueFormatter: emptyFormatter},
                            {headerName: '{{session('renames') ? session('renames')->job : 'Job'}}', field: 'trip', editable: false, cellRenderer: JobRenderer},
                            {headerName: '{{session('renames') ? session('renames')->po : 'PO'}}', field: 'customer_po', editable: false, cellRenderer: PoRenderer},
