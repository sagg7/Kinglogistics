        ...
        <div class="card-content">
            <div class="row">
                ...
                <div class="form-group col-md-3 col-sm-6">
                    ...
                    <div class="input-group">
                        {!! Form::select('account', $accounts, $expense->account_id ?? null, ['class' => 'form-control' . ($errors->first('account') ? ' is-invalid' : '')]) !!}
                        <div class="input-group-append">
                            <button class="btn btn-success pl-1 pr-1" type="button" data-toggle="modal" data-target="#expenseAccountModal"><i class="fas fa-plus"></i></button>
                        </div>
                        @error('account')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ ucfirst($message) }}</strong>
