<x-app-layout>
    ...
    @section('modals')
        ...
        @include('common.modals.deleteTypeModal', ['id' => 'deleteIncomeAccountModal', 'name' => 'Account', 'route' => 'incomeAccount.delete', 'selectId' => 'account', 'deleteSelectId' => 'delete_account'])
    @endsection
