                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            <a href="tel:{{ auth()->user()->phone }}" class="btn btn-sm btn-info mr-4">{{ __('Call') }}</a>
                            <a href="mailto:{{auth()->user()->email}}" class="btn btn-sm btn-default float-right">{{ __('Email') }}</a>
                        </div>
                    </div>
                    <div class="card-body pt-0 pt-md-4">
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Hoobs, New Mexico') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('CTO - King logistic Oil LLC') }}
                            </div>
                        </div>
                    </div>
                </div>
