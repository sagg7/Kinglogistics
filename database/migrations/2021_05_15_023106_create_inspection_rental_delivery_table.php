...
class CreateInspectionRentalDeliveryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_rental_delivery', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('inspection_rental_delivery');
    }
}
