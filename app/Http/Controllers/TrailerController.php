...
class TrailerController extends Controller
{
    ...
    {
        return [
            'trailer_types' => [null => 'Select'] + TrailerType::pluck('name', 'id')->toArray(),
            'statuses' => [null => 'Select'] + ['available' => 'Available', 'rented' => 'Rented', 'oos' => 'Ouf of service'],
        ];
    }
    ...
    private function storeUpdate(Request $request, $id = null): Trailer
    {
        ...
        $trailer->inactive = $request->inactive;
        $trailer->save();
