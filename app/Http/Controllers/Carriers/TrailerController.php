...
class TrailerController extends Controller
{
    ...
    {
        return view('subdomains.carriers.trailers.index');
    }
    ...
    public function create()
    {
        ...
        return view('subdomains.carriers.trailers.create', $params);
    }
    ...
    public function edit($id)
    {
        ...
        return view('subdomains.carriers.trailers.edit', $params);
    }
