    ...
    public function array(): array
    {
        switch ($this->paymentExportType) {
            ...
            $headers = [
                ...
                [
                    "#",
                    session('renames') ? session('renames')->carrier : 'Carrier',
                    "Truck #",
                    "Load Date",
                    "Driver",
                    "Destination",
                    session('renames') ? session('renames')->customer_reference : 'C Reference',
                    session('renames') ? session('renames')->control_number : 'Control #',
