...
/***/ "./resources/js/common/initSignature.js":
/*!**********************************************!*\
  !*** ./resources/js/common/initSignature.js ***!
  \**********************************************/
/***/ (() => {
...
(function () {
  var resizeCanvas = function resizeCanvas(canvas, sigPad) {
  ...
  $('form').submit(function (e) {
    sigPadArr.forEach(function (obj) {
      if (obj.required && obj.signaturePad.isEmpty()) {
        throwErrorMsg("The ".concat(obj.label, " is required"));
        e.preventDefault();
      } else obj.input.value = obj.signaturePad.toDataURL();
    });
  });
})();
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/common/initSignature.js")))
